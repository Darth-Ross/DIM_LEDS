...
This is a hardware description for PWM dimmed LEDS in VHDL. The repo was originally created to store my school assignment but I also figured someone else might have a use for this.
